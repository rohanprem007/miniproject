                            ...
                            <?php if ($result && $result->num_rows > 0): ?>
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="feedback-text"><?php echo htmlspecialchars($row['feedback_text']); ?></td>
                                        <td><?php echo date("d M, Y h:i A", strtotime($row['submitted_at'])); ?></td>
                                        <td class="actions">
                                            <a href="#" class="action-btn delete" title="Delete Feedback"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
