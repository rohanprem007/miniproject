...
<div class="dashboard-layout">
    <?php include 'sidebar.php'; // Use a separate file for the sidebar for code reusability ?>
                                ...
                                <?php while($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            <a href="#" class="action-btn edit" title="Edit Status"><i class="fas fa-pencil-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
