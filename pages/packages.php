<!-- 
    // This is a template. 
    // For packages.php, you will need to add the PHP data-fetching logic at the top.
-->
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <!-- The Title should be changed for each page -->
    <title>Page Title - TravelEase</title>
    ...
    <!-- Corrected Stylesheet Paths -->
    <link rel="stylesheet" href="../webpage/style.css">
    <link rel="stylesheet" href="page-style.css">
    <!-- Add payment-style.css for the payment page if needed -->
...
<body>
    ...
    <!-- Main Content (This part will be unique to each page) -->
